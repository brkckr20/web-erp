...
export default function HizmetListesi({ onSelect, onNew }: HizmetListesiProps) {
  const [data, setData] = useState<HizmetRow[]>([])
  ...
  const columns = useMemo<ColDef<HizmetRow>[]>(
    () => [
      {
        headerName: 'Kodu',
        field: 'kod',
      ...
      <div className="!p-3 !h-full !flex !flex-col">
        ...
        <div className="!bg-white !rounded-sm !flex-1 !min-h-0" style={{ minHeight: 300 }}>
          <DataGrid
            ...
            columnDefs={columns}
            domLayout="normal"
            exportFileName="alinan-hizmet-kartlari"
            storageKey="hizmetKarti"
            rowSelection="single"
