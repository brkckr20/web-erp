  ...
  async createKalem(receteId: number, dto: CreateKalemDto) {
    ...
    return this.prisma.receteKalem.create({
      data: {
        ...
        islem: dto.islem ?? null,
        variant1: dto.variant1 ?? null,
        variant2: dto.variant2 ?? null,
        suslemeSecimi: dto.suslemeSecimi ?? null,
        kesilecek: dto.kesilecek ?? null,
  ...
  async updateKalem(id: number, dto: UpdateKalemDto) {
    ...
    return this.prisma.receteKalem.update({
      ...
      data: {
        ...
        sira: dto.sira,
        islem: dto.islem,
        variant1: dto.variant1,
        variant2: dto.variant2,
        suslemeSecimi: dto.suslemeSecimi,
        kesilecek: dto.kesilecek,
